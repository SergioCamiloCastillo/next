      ...
      <nav className={navbar ? "navbar active" : "navbar"}>
        <div className="navbar-container container">
          ...
          <div className={click ? "nav-menu active" : "nav-menu"}>
              ...
              */}
              ...
              <li className="sub-menu-parent" tab-index="0">
                ...
                >
                  ...
                  Somos un equipo freelance formados con el propósito de desarrollar tu página web a tu medida, utilizando las tecnologías que más se adaptan a tus necesidades.
                  </div>
            ...
            */}
            <Link target='_BLANK' href='https://api.whatsapp.com/send?phone=573132719364' target='_BLANK'>
            ...
            <Link target='_BLANK' href='https://www.linkedin.com/in/sergio-camilo-castillo-nu%C3%B1ez-b541981ba/?originalSubdomain=co'>
            <span className="circle-social-links">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  aria-hidden="true"
